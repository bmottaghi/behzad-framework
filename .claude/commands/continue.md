I'm resuming work on feature: $ARGUMENTS

**READ CURRENT STATE:**
1. Read: docs/product-system.md - Find the feature entry for $ARGUMENTS
...
**PRESENT SUMMARY:**
```
Resuming: $ARGUMENTS - [Feature Title]
...
Report: "Feature $ARGUMENTS not found in product-system.md. Use /list-features to see available features."
